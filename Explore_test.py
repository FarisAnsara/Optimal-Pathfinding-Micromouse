...
class Explore:
    ...
    def find_path(self, start, goal, local_flood_map):
        start_flood_val = self.get_flood_value(start)
        goal_flood_val = self.get_flood_value(goal)
    ...
    def move_to_position(self, position, go_back_start = None):
    ...
    def find_nearest_undiscovered(self):
        ...
        return None  # All positions have been discovered
